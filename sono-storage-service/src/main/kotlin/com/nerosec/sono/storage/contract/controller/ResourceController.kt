...
import com.nerosec.sono.storage.contract.request.*
import com.nerosec.sono.storage.contract.response.ResourcesPage
import com.nerosec.sono.storage.persistence.entity.ResourceEntity_
import com.nerosec.sono.storage.service.ResourceService
import com.nerosec.sono.storage.service.ResourceService.Companion.SUPPORTED_PROPERTIES_TO_SORT_BY
...
class ResourceController(
    ...
    fun listStorages(
        ...
        id?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.ID] = it }
        parentId?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.PARENT_ID] = it }
        userId?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.USER_ID] = it }
        contentHash?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.CONTENT_HASH] = it }
        name?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.NAME] = it }
        extension?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.EXTENSION] = it }
        type?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.TYPE] = it }
        directory?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.DIRECTORY] = it }
        trashed?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.TRASHED] = it }
        version?.let { propertiesToQueryBy[com.nerosec.sono.storage.persistence.entity.ResourceEntity_.VERSION] = it }
